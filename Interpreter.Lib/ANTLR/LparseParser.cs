...
public partial class LparseParser : Parser {
	...
	public StatementContext statement() {
		...
		try {
			...
			case CONS:
				...
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4474910L) != 0)) {
					{
					State = 60;
					body();
					}
	...
	public ChoiceContext choice() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 278558L) != 0)) {
				{
				State = 107;
				term(0);
				State = 108;
	...
	private static int[] _serializedATN = {
		...
		0,0,53,54,1,0,0,0,54,3,1,0,0,0,55,53,1,0,0,0,56,57,3,30,15,0,57,58,5,7,
		0,0,58,5,1,0,0,0,59,61,5,12,0,0,60,62,3,10,5,0,61,60,1,0,0,0,61,62,1,0,
		0,0,62,63,1,0,0,0,63,74,5,5,0,0,64,66,3,8,4,0,65,67,5,12,0,0,66,65,1,0,
		0,0,66,67,1,0,0,0,67,69,1,0,0,0,68,70,3,10,5,0,69,68,1,0,0,0,69,70,1,0,
		0,0,70,71,1,0,0,0,71,72,5,5,0,0,72,74,1,0,0,0,73,59,1,0,0,0,73,64,1,0,
		0,0,74,7,1,0,0,0,75,78,3,12,6,0,76,78,3,14,7,0,77,75,1,0,0,0,77,76,1,0,
		0,0,78,9,1,0,0,0,79,85,3,28,14,0,80,82,5,11,0,0,81,80,1,0,0,0,81,82,1,
		0,0,0,82,83,1,0,0,0,83,85,3,20,10,0,84,79,1,0,0,0,84,81,1,0,0,0,85,96,
		1,0,0,0,86,92,5,6,0,0,87,93,3,28,14,0,88,90,5,11,0,0,89,88,1,0,0,0,89,
		90,1,0,0,0,90,91,1,0,0,0,91,93,3,20,10,0,92,87,1,0,0,0,92,89,1,0,0,0,93,
		95,1,0,0,0,94,86,1,0,0,0,95,98,1,0,0,0,96,94,1,0,0,0,96,97,1,0,0,0,97,
		11,1,0,0,0,98,96,1,0,0,0,99,104,3,30,15,0,100,101,5,10,0,0,101,103,3,30,
		15,0,102,100,1,0,0,0,103,106,1,0,0,0,104,102,1,0,0,0,104,105,1,0,0,0,105,
		...
		1,0,0,0,120,121,1,0,0,0,121,15,1,0,0,0,122,127,3,18,9,0,123,124,5,9,0,
		...
		8,0,0,132,134,3,26,13,0,133,131,1,0,0,0,133,134,1,0,0,0,134,19,1,0,0,0,
		...
		0,0,0,146,147,1,0,0,0,147,21,1,0,0,0,148,153,3,24,12,0,149,150,5,9,0,0,
		...
		8,0,0,158,159,3,26,13,0,159,164,1,0,0,0,160,164,3,36,18,0,161,162,5,8,
		0,0,162,164,3,26,13,0,163,156,1,0,0,0,163,160,1,0,0,0,163,161,1,0,0,0,
		164,25,1,0,0,0,165,170,3,28,14,0,166,167,5,6,0,0,167,169,3,28,14,0,168,
		166,1,0,0,0,169,172,1,0,0,0,170,168,1,0,0,0,170,171,1,0,0,0,171,27,1,0,
		0,0,172,170,1,0,0,0,173,175,5,11,0,0,174,173,1,0,0,0,174,175,1,0,0,0,175,
		...
		0,182,183,1,0,0,0,183,189,5,1,0,0,184,186,5,18,0,0,185,187,3,36,18,0,186,
		...
		202,3,38,19,0,198,199,5,6,0,0,199,201,3,38,19,0,200,198,1,0,0,0,201,204,
		1,0,0,0,202,200,1,0,0,0,202,203,1,0,0,0,203,37,1,0,0,0,204,202,1,0,0,0,
		205,206,6,19,-1,0,206,211,5,1,0,0,207,208,5,18,0,0,208,209,3,36,18,0,209,
		210,5,19,0,0,210,212,1,0,0,0,211,207,1,0,0,0,211,212,1,0,0,0,212,223,1,
		0,0,0,213,223,5,3,0,0,214,223,5,2,0,0,215,223,5,4,0,0,216,217,5,18,0,0,
